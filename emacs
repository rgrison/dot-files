...
(add-to-list 'package-archives '("melpa-stable" . "https://stable.melpa.org/packages/" )  ) ;; markdown mode
(add-to-list 'package-archives '("marmalade"    . "http://marmalade-repo.org/packages/") t) ;; utilisé pour autopair-mode


;; Utilisation de modes mineurs
(require 'autopair) ; complétion des paires
